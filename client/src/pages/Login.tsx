    ...
    <div style={{
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <h2 style={{ fontSize: '1.5rem', fontWeight: 800, letterSpacing: '-0.02em', color: '#1e293b' }}>Welcome back</h2>
          <p style={{ color: '#64748b', fontSize: '0.9rem', marginTop: 4 }}>Sign in to your account</p>
        </div>
        ...
        <p style={{ textAlign: 'center', marginTop: 20, color: '#64748b', fontSize: '0.9rem' }}>
          No account?{' '}
          <Link to="/register" style={{ color: '#4f46e5', fontWeight: 600, transition: 'color 0.2s' }}>Register</Link>
        </p>
      </form>
    </div>
  );
