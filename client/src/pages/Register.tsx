      ...
      <div style={leftPanelStyle}>
        <div style={brandBoxStyle}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '0.95rem', maxWidth: 280, textAlign: 'center', lineHeight: 1.7 }}>
            Join your team and start managing supply requests effortlessly.
          </p>
        </div>
      ...
      <div style={rightPanelStyle}>
        <div style={formContainerStyle}>
          <div style={{ marginBottom: '2rem' }}>
            <h2 style={{ fontSize: '1.6rem', fontWeight: 700, color: 'var(--text)', marginBottom: '0.35rem' }}>Create Account</h2>
            <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>Register to start requesting supplies</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} style={{ display: 'flex', flexDirection: 'column', gap: '1.15rem' }}>
            <div>
              ...
              <div style={inputWrapperStyle}>
                <User size={17} color="var(--text-light)" style={{ flexShrink: 0 }} />
                <input {...register('name')} placeholder="John Doe" style={inputStyle} />
              </div>
            ...
            <button type="submit" disabled={isSubmitting} style={btnStyle}>
              {isSubmitting ? <Loader2 size={18} /> : <><span>Create Account</span><ArrowRight size={17} /></>}
            </button>
          </form>
